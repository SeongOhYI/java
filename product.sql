...
VALUES(SEQ_CODE.NEXTVAL,100,2,2500000);
INSERT INTO SALE(SCODE, PCODE, QNT, SPRICE)
VALUES(SEQ_CODE.NEXTVAL,100,3,2400000);
INSERT INTO SALE(SCODE, PCODE, QNT, SPRICE)
VALUES(SEQ_CODE.NEXTVAL,101,1,2800000);
INSERT INTO SALE(SCODE, PCODE, QNT, SPRICE)
VALUES(SEQ_CODE.NEXTVAL,101,1,2800000);
SELECT * FROM SALE;

SELECT S.SCODE, S.PCODE, P.PNAME, 
S.SPRICE,S.QNT, S.SPRICE*S.QNT SSUM, P.PPRICE, 
